    ...
    <section id="about" className="scroll-snap-section min-h-screen py-20 pb-96 md:pb-20 lg:pb-20 bg-white flex items-center">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full ">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-y-12 lg:gap-y-0 gap-x-6 lg:items-stretch">
          ...
          <div className="w-full lg:col-span-7 lg:order-2 flex flex-col h-full lg:flex">
            {/* About Us Badge */}
            ...
            {/* Desktop: Mission and Vision Grid (hidden on mobile) */}
            <div className="hidden lg:grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
              {/* Mission */}
            ...
            <div className="hidden lg:flex pt-4 mt-auto justify-end">
              <Button
                text="Learn More"
                icon={
                  <img
          ...
          {/* Mobile: Bottom Section - Mission, Vision & Button */}
