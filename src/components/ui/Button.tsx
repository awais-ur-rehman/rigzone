...
export function Button({
  ...
  const variantClasses = {
    primary: 'text-[12px] lg:text-[16px] bg-[#E15E00] border border-[#E15E00] text-[#F6F4EB] hover:bg-[#c95600] focus:ring-[#E15E00] shadow-[0_4px_4px_rgba(0,0,0,0.25)] font-bold',
    secondary: 'text-[12px] lg:text-[16px] text-white hover:bg-[#E15E00] border border-[#F6F4EB] hover:border-transparent font-bold',
