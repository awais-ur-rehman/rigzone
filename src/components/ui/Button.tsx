...
interface ButtonProps {
  text: string;
  icon?: ReactNode;
  variant?: 'primary' | 'secondary' | 'outline' | 'footer';
  size?: 'sm' | 'md' | 'lg';
  className?: string;
  onClick?: () => void;
  href?: string;
...
export function Button({
  ...
  const variantClasses = {
    primary: 'text-[16px] bg-[#E15E00] text-[#F6F4EB] hover:bg-[#c95600] focus:ring-[#E15E00] shadow-[0_4px_4px_rgba(0,0,0,0.25)] font-bold',
    ...
    footer: 'text-[16px] bg-[#3E4C52] text-[#F6F4EB] hover:bg-[#3E4C52]/80 focus:ring-[#3E4C52] shadow-[0_4px_4px_rgba(0,0,0,0.25)]'
  };
